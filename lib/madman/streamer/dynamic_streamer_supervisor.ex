defmodule Madman.Streamer.DynamicStreamerSupervisor do
  use DynamicSupervisor

  require Logger

  alias Madman.Repo
  alias Madman.Streamer.Binance
  ...
  defp update_status(symbol, status)
    ...
    Repo.get_by(StreamingSetting, symbol: symbol)
