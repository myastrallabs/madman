defmodule Madman.TradeRobot.Trader do
  @moduledoc """
  ## State

    * symbol: SOLUSDT
    * budget/chunks: 总资产/购买次数, 1000/4, 第一次购买 250u，rebuy 3 次
    * buy_order: 购买订单信息
    * sell_order: 出售订单信息
    * buy_down_interval: 下降购买参数：0.1 = 10%, current_price: 100u, buy_down_interval: 0.1, 第一次购买价格约等于 90u
    * profit_interval：网格利润，0.2 = 20%, buy_price: 90u,
    * rebuy_interval: 再次购买参数，此价格基于 buy_price: buy price: 90u, rebuy_interval: 10%, 购买价格 81u
    * rebuy_notified: 是否已经开启 rebuy
    * tick_size: 价格位数
    * step_size: 数量位数
  ...
  alias Decimal, as: D
  alias Madman.Core.Struct.TradeEvent

  require Logger

  @binance_client Application.compile_env(:madman, :binance_client)
  @leader Application.get_env(:madman, :leader)
  @pubsub_client Application.get_env(:madman, :pubsub_client)
  ...
  defp calculate_sell_price(buy_price, profit_interval, tick_size) do
    # current_vip_level: vip: 0, 基本上都是 maker 费率暂定 0.1
  ...
  defp calculate_buy_price(current_price, buy_down_interval, tick_size) do
    ...
    # Example：SOL 最近成交价 current_price, 100u, 期望降低 10% 发起交易.
    # current_price: 100
    # buy_down_interval: 0.1
    # exact_buy_price 90
