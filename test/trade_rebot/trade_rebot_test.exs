defmodule Madman.TradeRebotTest do
  @moduledoc false
  ...
  test "Naive trader full trade(buy + sell) test" do
    ...
    Madman.Core.start_storing("ORDERS", "XRPUSDT")
    :timer.sleep(5000)
    ...
    # IO.inspect(Madman.Repo.all(query), label: "Madman.Repo.all(query)")

    [buy_1, sell_1, buy_2] = Madman.Repo.all(query)
